...
@patch("generate_suggestions.run.fetch_suggestions", MagicMock(return_value=MOCK_SUGGESTIONS))
...
@patch("generate_suggestions.run.validate_request", MagicMock(side_effect=ValidationError("test")))
...
@patch(
    "generate_suggestions.run.validate_request",
...
@patch("generate_suggestions.run.validate_request", MagicMock(side_effect=RuntimeError("an error occurred")))
