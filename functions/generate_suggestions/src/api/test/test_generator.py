...
from ...test.mocks import MOCK_GPT3_COMPLETION_RESPONSE, MOCK_REQUEST, MOCK_SUGGESTIONS
...
def test_generate_suggestions__when_request_is_valid__then_returns_parsed_suggestions_from_gpt3() -> None:
    mock_response: GenerateSuggestionsResponse = generate_suggestions(MOCK_REQUEST)
